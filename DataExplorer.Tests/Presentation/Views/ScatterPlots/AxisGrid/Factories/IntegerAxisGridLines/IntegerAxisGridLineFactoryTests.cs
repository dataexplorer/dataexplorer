...
namespace DataExplorer.Tests.Presentation.Views.ScatterPlots.AxisGrid.Factories.IntegerAxisGridLines
{
    [TestFixture]
    public class IntegerAxisGridLineFactoryTests
    {
        private IntegerAxisGridLineFactory _factory;

        [SetUp]
        public void SetUp()
        {
            _factory = new IntegerAxisGridLineFactory();
        }
