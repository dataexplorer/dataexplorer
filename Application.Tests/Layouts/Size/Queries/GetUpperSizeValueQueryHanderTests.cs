...
{
    [TestFixture]
    public class GetUpperSizeValueQueryHanderTests
    {
        private GetUpperSizeQueryHandler _handler;
        ...
        public void SetUp()
        {
            ...
            _handler = new GetUpperSizeQueryHandler(
        ...
        {
            var result = _handler.Execute(new GetUpperSizeQuery());
