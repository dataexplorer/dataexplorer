...
{
    [TestFixture]
    public class GetAllAxisColumnsQueryHandlerTests
        : BaseGetAllLayoutColumnsQueryHandlerTests
    {
        private GetAllAxisColumnsQueryHandler _handler;
        ...
        public override void SetUp()
        {
            ...
            _handler = new GetAllAxisColumnsQueryHandler(
        ...
        public void TestExecuteShouldIncludeColumnTypes(Type type)
        {
            ...
            var result = _handler.Execute(new GetAllAxisColumnsQuery());
