...
namespace DataExplorer.Domain.Tests.Maps.SizeMaps
{
    ...
    public class DateTimeToSizeMapTests
    {
        ...
        {
            var map = new DateTimeToSizeMap(DateTime.MinValue, DateTime.MaxValue, 0d, 100d);
        ...
        {
            var map = new DateTimeToSizeMap(DateTime.MinValue, DateTime.MaxValue, 0d, 1d);
        ...
        public void TestMapWithTimeValues(string time, double expected)
        {
            ...
            var map = new DateTimeToSizeMap(min, max, 0d, 1d);
